void gen_performance() {
  ...
  p_time->GetXaxis()->SetLabelSize(0.035);
  p_time->GetYaxis()->SetLabelSize(0.035);
  p_time->GetXaxis()->SetTitleSize(0.04);
  p_time->GetYaxis()->SetTitleSize(0.04);
  ...
  TGaxis *axis = new TGaxis(xmax,ymin,xmax,ymax,"f3",505,"G+L");
